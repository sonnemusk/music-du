  ...
  useEffect(() => {
    ...
    const bind = () => {
      ...
      const nodes = shell.querySelectorAll<HTMLElement>(
        ".side-player, .imm-now, .compact-now, .player-bar, .now-playing, .gal-dock, .dock-mini, .desk-dock, .feed-reel, .stage-floor, .verse-dock, .likes-mini, .rec-mini, .find-mini, .boards-mini, .split-player, .pocket-now, .pocket-mini"
      );
